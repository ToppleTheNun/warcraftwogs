...
export type GetWordOfGloryHealingEventsQueryVariables = Exact<{
  reportID: Scalars["String"]["input"];
  fightIDs:
    | Array<InputMaybe<Scalars["Int"]["input"]>>
    | InputMaybe<Scalars["Int"]["input"]>;
...
export type GetWordOfGloryHealingEventsQuery = {
  __typename?: "Query";
  reportData?: {
    __typename?: "ReportData";
    report?: {
...
`;
export const GetWordOfGloryHealingEventsDocument = gql`
